                        ...
                        <div>
                            ...
                            <div class="flex items-end gap-2">
                                <div class="flex-1 text-center">
                                    <input wire:model="temps_heures" type="number" min="0" max="99"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm text-center focus:outline-none focus:ring-2 focus:ring-blue-400"
                                           placeholder="0">
                                    <p class="text-xs text-gray-400 mt-0.5">heures</p>
                                </div>
                                <span class="text-gray-400 font-semibold pb-5">:</span>
                                <div class="flex-1 text-center">
                                    <input wire:model="temps_minutes" type="number" min="0" max="59" step="5"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm text-center focus:outline-none focus:ring-2 focus:ring-blue-400"
                                           placeholder="00">
                                    <p class="text-xs text-gray-400 mt-0.5">minutes</p>
                                </div>
                            </div>
                        </div>
                    </div>
