<div>
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('panel.compagnie.voyages.create') }}" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-4 py-2 rounded-lg transition-colors">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-4 py-3 text-right">
                            <div class="flex items-center justify-end gap-1">
                                ...
                                <a href="{{ route('panel.compagnie.voyages.edit', ['voyageId' => $voyage->id]) }}" class="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
