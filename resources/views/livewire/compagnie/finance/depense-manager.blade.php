<div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
        <div class="px-4 py-3 border-b border-gray-100 flex flex-col sm:flex-row gap-3">
            ...
            <select wire:model.live="categorieFilter" class="px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400">
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                @empty
                    <tr><td colspan="6" class="px-4 py-10 text-center text-gray-400">Aucune dépense trouvée</td></tr>
                @endforelse
            </tbody>
        </table>
