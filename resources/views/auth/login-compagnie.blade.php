<x-guest-layout>
    <x-authentication-card>
        ...
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-surface-900 dark:text-white">Espace Compagnie</h2>
            <p class="mt-1 text-sm text-surface-500 dark:text-surface-400">Connectez-vous à votre espace de gestion</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-5">
            ...
            <div>
                ...
                <x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="contact@compagnie.com" />
            </div>
